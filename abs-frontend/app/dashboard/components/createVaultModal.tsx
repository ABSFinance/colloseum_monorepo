...
import { X, ChevronRight, ChevronDown, ChevronLeft, Search } from "lucide-react"
...
export function CreateVaultModal({ isOpen, onClose }: CreateVaultModalProps) {
    ...
    const [allocations, setAllocations] = useState<AllocationItem[]>([
        { id: "1", name: "ABS", strategy: "strat", percentage: 30 },
        { id: "2", name: "ABS", strategy: "strat", percentage: 30 },
        { id: "3", name: "ABS", strategy: "strategy", percentage: 40 },
    ])
                    ...
                    >
                        ...
                        {activeTab === "preview" && (
                            <div className="space-y-6">
                                ...
                                <p className="text-gray-400">Review your vault settings before creation.</p>
                        ...
                        <div className="mt-8 flex justify-between">
                            ...
                            >
                                {activeTab === "preview" ? "Create Vault" : "Next"}
