...
export default function Navbar() {
    ...
    return (
        <motion.header
            ...
            className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? "bg-black/80 backdrop-blur-md py-2" : "bg-transparent py-4"
                }`}
        >
            ...
            {mobileMenuOpen && (
                ...
                >
                    <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
                        ...
                        <MobileNavLink href="#yield" onClick={() => setMobileMenuOpen(false)}>
                            Plans
                        </MobileNavLink>
...
function NavLink({ href, children }: { href: string; children: React.ReactNode }) {
    return (
        <Link href={href} className="text-gray-300 hover:text-white transition-colors text-sm font-medium">
            {children}
        </Link>
    )
}
